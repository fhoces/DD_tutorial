...
As an illustration lets write a report use the participants in this workshop to illustrate the famous [birthday paradox](https://en.wikipedia.org/wiki/Birthday_problem). 
